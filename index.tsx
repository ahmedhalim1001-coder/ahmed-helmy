...
// --- ICONS ---
const SunIcon = () => ( <svg xmlns="http://www.w.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="24" height="24"><path d="M12 2.25a.75.75 0 01.75.75v2.25a.75.75 0 01-1.5 0V3a.75.75 0 01.75-.75zM7.5 12a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM18.894 6.106a.75.75 0 010 1.06l-1.591 1.591a.75.75 0 11-1.06-1.06l1.591-1.591a.75.75 0 011.06 0zM21.75 12a.75.75 0 01-.75.75h-2.25a.75.75 0 010-1.5H21a.75.75 0 01.75.75zM17.803 17.803a.75.75 0 01-1.06 0l-1.591-1.591a.75.75 0 111.06-1.06l1.591 1.591a.75.75 0 010 1.06zM12 18a.75.75 0 01.75.75v2.25a.75.75 0 01-1.5 0v-2.25A.75.75 0 0112 18zM5.197 17.803a.75.75 0 010-1.06l1.591-1.591a.75.75 0 111.06 1.06l-1.591 1.591a.75.75 0 01-1.06 0zM3 12a.75.75 0 01.75-.75h2.25a.75.75 0 010 1.5H3.75A.75.75 0 013 12zM6.106 5.197a.75.75 0 011.06 0l1.591 1.591a.75.75 0 11-1.06 1.06L5.197 6.257a.75.75 0 010-1.06z" /></svg> );
const MoonIcon = () => ( <svg xmlns="http://www.w.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="24" height="24"><path fillRule="evenodd" d="M9.528 1.718a.75.75 0 01.162.819A8.97 8.97 0 009 6a9 9 0 009 9 8.97 8.97 0 003.463-.69.75.75 0 01.981.98 10.503 10.503 0 01-9.694 6.46c-5.799 0-10.5-4.701-10.5-10.5 0-3.832 2.072-7.147 5.228-8.97a.75.75 0 01.818.162z" clipRule="evenodd" /></svg> );
const BedIcon = () => ( <svg xmlns="http://www.w.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M3.375 3C2.339 3 1.5 3.84 1.5 4.875v10.75c0 1.036.84 1.875 1.875 1.875h17.25c1.035 0 1.875-.84 1.875-1.875V4.875C22.5 3.839 21.66 3 20.625 3H3.375zM9 12h12V4.875c0-.621-.504-1.125-1.125-1.125H9v8.25zM7.5 15.75V4.875c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125V15.75c0 .621.504 1.125 1.125 1.125h3c.621 0 1.125-.504 1.125-1.125z" /></svg> );
const BathIcon = () => ( <svg xmlns="http://www.w.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M3.5 8.25a.75.75 0 000 1.5h2.25V15a4.505 4.505 0 004.5 4.5H18v-1.528A4.522 4.522 0 0014.25 12H12V4.5A2.25 2.25 0 009.75 2.25h-3A2.25 2.25 0 004.5 4.5v1.5H3.5a.75.75 0 00-.75.75v1.5a.75.75 0 00.75.75zM12 12.75H13.5a.75.75 0 00.75-.75V8.25a.75.75 0 00-.75-.75H12v5.25z" /></svg> );
const AreaIcon = () => ( <svg xmlns="http://www.w.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path fillRule="evenodd" d="M8.25 6.75a3.75 3.75 0 117.5 0 3.75 3.75 0 01-7.5 0zM15.75 9.75a3 3 0 116 0 3 3 0 01-6 0zM2.25 9.75a3 3 0 116 0 3 3 0 01-6 0zM6 12.75a3 3 0 116 0 3 3 0 01-6 0zM12.75 15a3 3 0 116 0 3 3 0 01-6 0z" clipRule="evenodd" /></svg> );
const LocationIcon = () => ( <svg xmlns="http://www.w.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="16" height="16"><path fillRule="evenodd" d="M11.54 22.351l.07.04.028.016a.76.76 0 00.723 0l.028-.015.071-.041a16.975 16.975 0 005.169-4.4c3.95-6.193 3.4-11.952-1.2-15.54C15.34.468 12.26 0 8.5 0 4.74 0 1.66.468.04 3.486-4.56 7.073-4.01 12.833-.06 19.023a16.975 16.975 0 005.169 4.4c.195.11.39.213.58.309zM12 2.25c2.518 0 4.886.953 6.625 2.658 2.348 2.305 3.235 5.823 1.838 9.394-.725 1.83-2.06 3.73-3.8 5.613a15.483 15.483 0 01-4.663 3.633.45.45 0 01-.4 0A15.483 15.483 0 017.04 19.923c-1.74-1.883-3.075-3.783-3.8-5.613-1.397-3.57-0.51-7.09 1.838-9.394C6.826 3.33 9.4.99 12 .99z" clipRule="evenodd" /><path d="M12 6.75a3.75 3.75 0 100 7.5 3.75 3.75 0 000-7.5zM8.25 10.5a3.75 3.75 0 117.5 0 3.75 3.75 0 01-7.5 0z" /></svg> );
const MenuIcon = () => ( <svg xmlns="http://www.w.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" width="24" height="24"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" /></svg>);
const CloseIcon = () => (<svg xmlns="http://www.w.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" width="24" height="24"><path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12" /></svg>);
...
const App = () => {
  ...
  useEffect(() => {
    const fetchProperties = async () => {
        ...
        try {
            ...
            parsedProperties.forEach(p => fetchImageForProperty(p.id, p.description.en));
        } catch (e) {
            console.error(e);
    ...
    const fetchImageForProperty = async (id, description) => {
        ...
        } catch (e) { console.error(`Failed to generate image for property ${id}:`, e); }
    };
  ...
  const formatPrice = (price) => new Intl.NumberFormat(language === 'ar' ? 'ar-EG' : 'en-US').format(price);
            ...
            <div className="property-list">
                ...
                <div key={prop.id} className="property-card">
                    <div className="property-image-container">
                        {imageCache[prop.id] ? (
                            <img src={imageCache[prop.id]} alt={prop.title[language]} className="property-image" />
                        ) : (
                    ...
                    <div className="property-details">
                        ...
                        <div className="property-pricing">
                            <div className="price">{formatPrice(prop.price)} <span className="price-unit">{t.priceUnit}</span></div>
                            <div className="down-payment">{t.downPayment}: {formatPrice(prop.downPayment)} {t.priceUnit}</div>
                        </div>
                        <div className="property-actions">
                            <button className="action-button primary-action">{t.contactAgent}</button>
                            <button onClick={() => setMapProperty(prop)} className="action-button">{t.viewOnMap}</button>
                        </div>
                    </div>
                </div>
                ))}
